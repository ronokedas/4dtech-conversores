...
export const metadata: Metadata = {
  ...
  description: "Converta HTML em PDF, remova fundo de imagens e acesse ferramentas online para Word, Excel e PDF.",
  alternates: { canonical: "/" },
};

export default function Home() {
  const featuredTools = ["html-para-pdf", "remover-fundo-de-imagem", "comprimir-pdf", "juntar-pdf"].map((slug) => getToolBySlug(slug)!);
  return <>
    <section className="platform-hero">
      <div className="container platform-hero-inner">
        <div className="platform-copy">
          <h1>Ferramentas online para documentos e imagens.</h1>
          <p>Converta HTML em PDF, remova fundo de imagens PNG e acesse modulos exclusivos para Word, Excel e PDF.</p>
        </div>
